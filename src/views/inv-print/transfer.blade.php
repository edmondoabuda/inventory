                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="col col-md-1">Source Warehouse</th>
                            <th class="col col-md-1">Destination Warehouse</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span>{{ $item['warehouse_from_name'] }}</span>
                            </td>
                            <td>
                                <span>{{ $item['warehouse_to_name'] }}</span>
                            </td>
                            <td class="alignright">
                                <span>{{ $item['qty'] }}</span>
                            </td>
