...
<div class="create">
    <div class="row">
        <div class="col col-lg-4 col-xs-12">
            ...
            <h1 class="no-top">Edit Warehouse</h1>
        </div>
    </div>
    <div class="row">
        <div class="col col-lg-3 col-md-4 col-sm-6">
            {{ Form::model($warehouse, array('route' => array($basepath.'.update', $warehouse->id), 'method' => 'PUT')) }}
                ...
                {{ Form::submit('Update Warehouse', array('class' => 'btn btn-primary')) }}
