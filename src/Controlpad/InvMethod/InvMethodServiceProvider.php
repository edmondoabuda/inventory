...
class InvMethodServiceProvider extends ServiceProvider {
	...
	public function boot()
	{
        ...
        $this->app->booting(function()
        {
            ...
            $loader->alias('InvMethod', 'Controlpad\InvMethod\InvMethodFacade');
        });
	...
	{
		$this->app['invmethod'] = $this->app->share(function($app)
        {
            return new InvMethod($app['view'], $app['config']);
        });
	}
